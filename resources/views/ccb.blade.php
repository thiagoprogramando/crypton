...
<html style="font-size: 16px;" lang="pt">
    ...
    <body data-home-page="./" data-home-page-title="Página Inicial" data-path-to-root="./" data-include-products="true" class="u-body u-overlap u-overlap-contrast u-xl-mode" data-lang="pt">
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="fr-view u-clearfix u-rich-text u-text u-text-1">
          ...
          <p id="isPasted">
            <span style="font-size: 1.25rem;">Investir é fundamental para um futuro financeiro sólido. Na Azurita Capital, entendemos essa importância, comprometendo-nos a preservar e fazer crescer seu capital. Oferecemos opções de investimento, incluindo a CCB, combinando segurança e rentabilidade. Personalizamos soluções para atender às suas metas específicas, guiando-o rumo ao sucesso financeiro. Conte com a Azurita Capital para transformar seus sonhos em realidade.&nbsp;</span>
          </p>
        </div>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-grey-5 u-section-2" id="sec-6da0">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <p class="u-text u-text-2"> Em nossa plataforma, cada produto exibe prazos e rentabilidades claramente declarados na página correspondente. Além disso, oferecemos uma calculadora rentável, permitindo que você simule e planeje sua carteira de investimentos de forma transparente e conveniente.</p>
        <a href="#" class="u-border-none u-btn u-btn-rectangle u-button-style u-color-scheme-summer-time u-custom-color-1 u-radius-0 u-btn-1">Quero investir</a>
      </div>
    </section>
            ...
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <p class="u-text u-text-default u-text-1">Aqui será o gráfico</p>
                </div>
              </div>
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <p class="u-text u-text-default u-text-2">Aqui será a calculadora</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <p class="u-text u-text-default u-text-1">
                    <span style="font-weight: 700; font-size: 1.875rem;"> Cédula de Crédito Bancário (CCB)</span>
                    <br>
                    <br>A Cédula de Crédito Bancário (CCB) é um título de crédito emitido por pessoa física ou jurídica em favor de uma instituição financeira ou de entidade que se assemelhe. Acima de tudo, o Projeto de Lei número 8.987/17 autoriza a emissão da Cédula de Crédito Bancário Digital. Desta forma, a cédula eletrônica se equipara à cédula física
                  </p>
                </div>
              </div>
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <p class="u-text u-text-default u-text-2">
                    ...
                    <br>
                    <br>A CCB possui Imposto de Renda Retido na Fonte. Em outras palavras, na data de retirada, o imposto será deduzido do seu investimento de forma automática com base na tabela regressiva. Vale lembrar que o imposto de renda irá incidir somente sobre a REMUNERAÇÃO do investimento e não sobre o montante.<br>
                  </p>
                </div>
              </div>
            </div>
