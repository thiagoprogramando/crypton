                    ...
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalFilterWithdraw">Filtrar</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($withdraws as $key => $withdraw)
                                    <tr>
                                        ...
                                        <td><strong>{{ $withdraw->user->name }}</strong></td>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('approvedWithdraw') }}" method="POST">
                                                @csrf
                                                ...
                                                <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        ...
                                                        <button type="submit" class="btn btn-outline-success"> <i class="tf-icons bx bx-check"></i> </button>
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
